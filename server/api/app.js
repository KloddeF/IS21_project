...
const ChatManager = require('./application/modules/chat/chatManager.js');
const ClassHandler = require('./application/modules/class/classHandler.js');
